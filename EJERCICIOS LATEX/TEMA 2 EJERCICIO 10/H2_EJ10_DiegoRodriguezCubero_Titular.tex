...
\begin{frame}[fragile]{Explicación del algoritmo}
    ...
    \begin{lstlisting}[language=C++]
        struct Nodo {
            ...
            int prioridad; // Altura del pilar más bajo en la asignación actual (se puede cambiar por la cota optimista si se prefiere)
...
\begin{frame}{Complejidad del algoritmo}
    ...
    El coste en espacio es $O(4^n)$, ya que en el peor caso se pueden almacenar todas las combinaciones posibles de asignación de los fragmentos a los pilares en la cola de prioridad.\\
