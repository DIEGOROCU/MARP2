...
\begin{frame}[fragile]{Explicación del algoritmo}
    ...
    \begin{lstlisting}[language=C++]
        struct Nodo {
            ...
            int cota_op; // Cota optimista para el nodo actual y prioridad
        };
    \end{lstlisting}
\end{frame}
...
\begin{frame}{Complejidad del algoritmo}
    ...
    El coste en espacio es $O(n4^n)$, ya que en el peor caso se pueden almacenar todas las combinaciones posibles de asignación de los fragmentos a los pilares en la cola de prioridad, cada uno con un coste de $O(n)$ para almacenar las asignaciones.\\
