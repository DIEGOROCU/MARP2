...
\section{Pseudocódigo para la verificación}
\begin{frame}[fragile]{Pseudocódigo para la verificación}
...
\begin{frame}[fragile]{Pseudocódigo para la verificación (continuación)}
    \begin{lstlisting}[basicstyle=\ttfamily\footnotesize]
